...
13 emulator checks cover pairing, layout, reconnection, sleep/wake, microphone enumeration and visible service lifecycle. The Windows coordinator also verifies receipt of Android PCM audio packets. The release APK is checked with apksigner and retains the existing signing identity.
